...
3. FFmpeg assembly: each clip blur-padded to full-frame 9:16 portrait, stitched end-to-end. Whisper captions burned from the clips' own audio. Small logo bottom-right. NO avatar, NO top bar, NO flag, NO sidebar, NO ticker.
...
- Chrome: NONE expected except the small logo bottom-right. If you see a top bar, flag, sidebar, or ticker — THAT is a violation. Their absence is correct.
...
4. Layout: full-frame portrait clip with blur-pad background throughout? logo visible bottom-right?
