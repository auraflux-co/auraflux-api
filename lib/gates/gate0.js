...
function commit(jobSpec) {
  ...
  return {
    ...
    committed: `I will confirm ${items.length} source(s) resolve, video is accessible, duration ${durationRange}, format is [${outputFormat}], and titles match the order. My confirmedFormat is authoritative for all downstream gates.`,
