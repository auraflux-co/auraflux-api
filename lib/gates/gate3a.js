...
- Per spec: NO avatar, NO broadcast top bar, NO flag, NO sidebar, NO ticker.
- Burned hook: ${hookZone}.
- Logo: ${hasLogo ? `${logoSize}px at ${logoZone}` : 'none expected — logo OFF'}.
- ${whisperOn ? 'Whisper captions REQUIRED at bottom of frame (dynamic speech transcription) — separate from the static hook line.' : 'Whisper captions OFF for this preset.'}
