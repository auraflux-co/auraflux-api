...
- IMPORTANT: Only flag sourceClipsVisible=false as an ISSUE if you are sampling WITHIN a scene marked as CLIP. If the sample is in a HOOK, REACTION, INTRO, or OUTRO scene, seeing only avatar is CORRECT.
