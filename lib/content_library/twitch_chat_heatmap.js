...
// Prefer dedicated GQL Client-ID; do NOT fall back to Helix TWITCH_CLIENT_ID
// (app Client-Ids return HTTP 400 on public VideoComments persisted queries).
...
function chatHeatmapToSegments(heatmap, opts = {}) {
  return heatmapToSegments(heatmap, {
    ...
    ...s,
    title: `Chat peak #${i + 1}`,
    summary: 'High chat velocity window',
    source: 'twitch_chat_heatmap',
  }));
}
