 ...
 * Feature-gated: requires planTier >= 'guided'.
 *
 * @param {object} params
 ...
 */
async function getVoiceRecommendations({ audioPath, overrides = {}, planTier = 'guided' } = {}) {
  if (!isFeatureEnabled('tts.elevenlabs', planTier) && planTier !== 'guided' && planTier !== 'managed' && planTier !== 'custom') {
