...
function resolveProductionProfileAndContentType(body) {
  ...
  if (b.contentType && NON_ALIAS_CONTENT_TYPES.has(_normalizeLegacyContentType(b.contentType) || b.contentType)) {
    ...
    // CPD-486: format:longform explicitly opts out of portrait crop even for clips jobs
 ...
 *   expectedPortals — which portals should be active (portal4 inactive for clips)
...
const KNOWN_CLEAN_PATHS = {
  tiktok_clutch: {
    ...
    expectedPortals: { portal0: true, portal3a: true, portal3b: true, portal5: true, portal1: false, portal2: false, portal4: false },
    outputShape: { aspectRatio: '9:16', dimensions: '720x1280' },
    notes: 'Short-form clip compilation. Portrait crop. No avatar. Portal 4 inactive for clips.',
  },
  youtube_deep_dive: {
    ...
    notes: 'Longform clip compilation. Landscape. No avatar. broadcast_desk prevents 9:16 crop.',
  },
  irl_story_time: {
    ...
    expectedPortals: { portal0: true, portal3a: true, portal3b: true, portal5: true, portal1: false, portal2: false, portal4: false },
    outputShape: { aspectRatio: '9:16', dimensions: '720x1280' },
    notes: 'IRL portrait compilation. Warm grade. Bottom captions.',
  },
  montage_hype_reel: {
    ...
    expectedPortals: { portal0: true, portal3a: true, portal3b: true, portal5: true, portal1: false, portal2: false, portal4: false },
    outputShape: { aspectRatio: '9:16', dimensions: '720x1280' },
    notes: 'High-energy portrait montage. Vivid grade, zoom + transitions.',
  },
  reaction_cut: {
    submission: { contentType: 'clips', format: 'longform', platforms: ['youtube'] },
    expectedRouting: { productionProfile: 'broadcast_desk', templateId: 'long-form' },
    expectedPortals: { portal0: true, portal3a: true, portal3b: true, portal5: true, portal1: false, portal2: false, portal4: false },
    outputShape: { aspectRatio: '16:9', dimensions: '1920x1080' },
    notes: 'Longform reaction compilation. Landscape. No avatar. broadcast_desk prevents 9:16 crop.',
  },
  quick_guide: {
    ...
    expectedPortals: { portal0: true, portal3a: true, portal3b: true, portal5: true, portal1: false, portal2: false, portal4: false },
    outputShape: { aspectRatio: '9:16', dimensions: '720x1280' },
    notes: 'Short tutorial/guide format. Cool grade, clean captions.',
  },
};
