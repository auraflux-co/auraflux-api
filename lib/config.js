...
const CONFIG = {
  ...
  VISUAL_LAYOUTS: {
    ...
    SHORT_FORM: {
      ...
      // Clips-only comp (blur-pad 9:16): logo centered in the top blur fold above landscape footage
      CLIP_COMP_LOGO: {
      ...
      // 16:9 sharp zone ends here on 1080×1920 blur-pad (top blur + 607px footage)
