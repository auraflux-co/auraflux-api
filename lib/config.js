...
// AuraFlux production configuration constants
...
const CONFIG = {
  ...
  VISUAL_LAYOUTS: {
    ...
    SHORT_FORM: {
      WIDTH: 1080,
      HEIGHT: 1920,
      AVATAR_ZONE: { x: 0, y: 0, w: 1080, h: 960 }, // Top Half (Bobby G)
      CLIP_ZONE: { x: 0, y: 960, w: 1080, h: 960 }, // Bottom Half (source clip)
      BURN_IN_ZONE: { x: 540, y: 960, anchor: 'center' }, // Floating middle
      LOGO_POS: { x: 900, y: 1800, size: 80, opacity: 0.85 }, // Split-screen shorts — bottom-right on avatar mug
      // Clips-only comp (brand-pad 9:16): logo centered in the top navy band above landscape footage
      CLIP_COMP_LOGO: {
        topBlurBand: 656, // (1920 - 1080*9/16) / 2 for 16:9 @ 1080w
        maxWidth: 880,
        maxHeight: 220,
        opacity: 0.92,
      },
      // 16:9 sharp zone ends here on 1080×1920 brand-pad (top navy + 607px footage)
      CLIP_COMP_SHARP_BOTTOM: 1264,
      // Letterbox fill for blur_pad / brand-pad mode (ClipzWorld near-black navy)
      BRAND_PAD_COLOR: '0x0d1424',
    },
  },
  NBA: {
