...
EXPECTED SCENES: ${expectedScenes}`;
  ...
  const checklist = isShortForm ? (contentType === 'news-short' ? [
   ...
   - Are there exactly ${expectedScenes} === SCENE === markers?`,
    ...
    `10. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text: "Hello everyone! You are tuning into The Other Side of the Pillow brought to you by ClipzWorld News. Where we appreciate our favorite streamers on Twitch. I am your host Bobby G. Let's get to it." FAIL (-15) if the intro deviates from this wording.`,
...
EXPECTED [CLIP PLAYS HERE] COUNT: ${expectedClips}`;
  ...
  const checklist = isTwitch ? [
    ...
    `9. LOCKED INTRO (-15 if wrong): The script MUST open with: "Other Side of the Pillow. ClipzWorld News." FAIL (-15) if the intro is missing or uses a different show name.`,
