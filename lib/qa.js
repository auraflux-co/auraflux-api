...
${isShortForm ? `  - Items 1, 2, 3: -15 each (critical — structure must be exact)
  - Item 4: -10 (caption style/length)
  IMPORTANT FOR SHORT-FORM: The REACTION line does NOT need to match the clip content.
  Non-sequitur reactions are intentional and correct. Only fail REACTION if it is more than
  1 sentence, contains hype words, or has exclamation points. NEVER deduct for content mismatch
  on the REACTION. NEVER populate fabricatedContent[] for short-form scripts.` :
