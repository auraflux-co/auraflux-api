...
1. The system generated a short-form scaffold with UNIVERSAL scene headers:
   - clips-short: INTRO → HOOK → CLIP → REACTION → OUTRO
   - sports-short: INTRO → CLIP → NARRATION → OUTRO
   - news-short: INTRO → SETUP → HOOK → OUTRO (no clip — avatar only)
   Scene names are UNIVERSAL (CLIP, HOOK, SETUP) not content-specific (STORY1_CLIP, NBA_SHORT).
   ACCEPT any of these universal headers as valid. Do NOT require STORY1_INTRO or similar old names.
