...
async function geminiScriptQA(script, clipAnalyses, opts = {}) {
  const { contentType = 'twitch', streamers = [], clipsPerStreamer = 2, jobId = 'unknown' } = opts;
...
EXPECTED [CLIP PLAYS HERE] COUNT: ${expectedClips}`;
  ...
  const checklist = isTwitch
    ? [
        ...
        `9. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain: "Welcome to Twitch Soup. I'm your host ${speakerName}, and for the next few minutes I'll be your guide through the world of livestreaming. Let's get into it." FAIL (-15) if the intro deviates from this wording.`,
    ...
    : isNBA
      ? [
          ...
          `2. OUTRO: Does the script end with "Goodnight and good luck."?`,
          ...
          `8. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain: "What's up, ClipzWorld! Grab your shades, because we're heading to the Other Side of the Pillow. I'm ${speakerName}, and we're breaking down the highlights that weren't just good—they were cold." FAIL (-15) if the intro deviates from this wording.`,
      ...
      : isNews
        ? [
            ...
            `8. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain: "I'm ${speakerName}, and this is Because the Light was on. I'm told this is the news." FAIL (-15) if the intro deviates from this wording.`,
