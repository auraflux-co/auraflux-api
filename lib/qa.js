...
If all 4 checks pass, all four arrays are [].`
  ...
  : `You are a senior QA reviewer for ClipzWorld News. Gemini just wrote a script for a video that will be generated using HeyGen's Bobby G avatar. You watched the clips. Cross-check the script against what you know about each clip.

Take your time. Read the full script carefully before scoring anything. A thorough, accurate review is far more valuable than a fast one. When in doubt about whether something is a real problem, give the script the benefit of the doubt — false positives waste HeyGen credits and delay production.
