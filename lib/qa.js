...
EXPECTED SCENES: ${expectedScenes}`;
  ...
  const checklist = checklistMod
   ...
   - Are there exactly ${expectedScenes} === SCENE === markers?`,
    ...
    `10. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text: "Welcome to Twitch Soup. I'm your host Bobby G, and for the next few minutes, I'll be your guide through this world of livestreaming. Let's jump right into it." FAIL (-15) if the intro deviates from this wording.`,
