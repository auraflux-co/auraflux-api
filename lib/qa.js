...
EXPECTED SCENES: ${expectedScenes}`;
  ...
  // Short-form: 3 checks only — clip marker, spoken lines, caption
  const checklist = isShortForm ? [
    `1. CLIP MARKER: Is there exactly 1 [CLIP PLAYS HERE] marker?`,
    `2. SPOKEN: Is there a SPOKEN: line with 1-2 sentences? Flat delivery, no hype words, no exclamation points, based on what Gemini saw in the clip.`,
    `3. CAPTION: Is there a CAPTION: line with 3-6 words suitable for a screen text overlay?`
  ] : isTwitch ? [
