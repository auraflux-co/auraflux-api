...
EXPECTED SCENES: ${expectedScenes}`;
  ...
  const checklist = isShortForm ? (contentType === 'news-short' ? [
   ...
   - Are there exactly ${expectedScenes} === SCENE === markers?`,
    ...
    `10. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text: "Other Side of the Pillow. ClipzWorld News. I'm Bobby G." FAIL (-15) if the intro deviates from this wording.`,
   ...
   - Are there exactly ${expectedScenes} === HEADER === markers?`,
    ...
    `9. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text: "This is ClipzWorld News. Because the Light Was On. Here is what happened." FAIL (-15) if the intro deviates from this wording.`,
...
EXPECTED [CLIP PLAYS HERE] COUNT: ${expectedClips}`;
  ...
  const checklist = isTwitch ? [
    ...
    `9. LOCKED INTRO (-15 if wrong): The script MUST open with: "Other Side of the Pillow. ClipzWorld News." FAIL (-15) if the intro deviates from this wording.`,
    ...
    `8. LOCKED INTRO (-15 if wrong): The script MUST open with: "Because the Light Was On. ClipzWorld News." (for shorts) or "This is ClipzWorld News. Because the Light Was On. Here is what happened." (for compilations). FAIL (-15) if the intro deviates from this wording.`,
