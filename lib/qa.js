...
EXPECTED SCENES: ${expectedScenes}`;
  ...
  const checklist = isShortForm ? (contentType === 'news-short' ? [
   ...
   - Are there exactly ${expectedScenes} === SCENE === markers?`,
    ...
    `10. LOCKED INTRO: Does the video open with the correct "Other Side of the Pillow" intro?`,
   ...
   - Are there exactly ${expectedScenes} === HEADER === markers?`,
    ...
    `9. LOCKED INTRO: Does the script open with the correct "Because the Light Was On" intro?`,
...
EXPECTED [CLIP PLAYS HERE] COUNT: ${expectedClips}`;
  ...
  const checklist = isTwitch ? [
    ...
    `8. LOCKED INTRO: Does the video open with the correct "Because the Light Was On" intro?`,
