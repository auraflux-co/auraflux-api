...
EXPECTED SCENES: ${expectedScenes}`;
  ...
  // Short-form scripts use a single === TYPE SHORT === header — simpler checklist
  // news-short has no [CLIP PLAYS HERE] (Bobby G reads one story, no video clip)
  const checklist = isShortForm ? (contentType === 'news-short' ? [
    `1. CLIP MARKERS: Confirm there are NO [CLIP PLAYS HERE] markers — news-short is Bobby G only, no clip.`,
    `2. OUTRO: Does the script end with "Appreciate you!"?`,
    `3. COLD OPEN: Does the script open with "The Daily Update. ClipzWorld News."?`,
    `4. WORD COUNT: Is the total spoken content 40-70 words? (Shorts must be concise — fail if over 80 words)`,
    `5. STORY ACCURACY: Does the script accurately reflect the headline and article text? No invented facts.`,
    `6. FLAT DELIVERY: Is the tone flat and deadpan throughout? No exclamation marks, no hype words like "incredible" or "amazing".`,
    `7. OBSERVATION: Is there exactly 1 flat, deadpan observation that makes the story more alarming?`
  ] : [
    `1. CLIP COUNT: Is there exactly 1 [CLIP PLAYS HERE] marker? (Short-form MUST have exactly 1)`,
    `2. OUTRO: Does the script end with "Appreciate you!"?`,
    `3. COLD OPEN: Does the script open with "The Daily Update. ClipzWorld News."?`,
    `4. WORD COUNT: Is the total spoken content 40-70 words? (Shorts must be concise — fail if over 80 words)`,
    `5. BEAT PLACEMENT: Is [beat] present before AND after every [CLIP PLAYS HERE]?`,
    `6. CLIP MATCH: Does the setup/intro accurately reflect what Gemini saw in the clip? No invented details.`,
    `7. FLAT DELIVERY: Is the tone flat and deadpan throughout? No exclamation marks, no hype words like "incredible" or "amazing".`,
    `8. REACTION: Is there exactly 1 flat reaction sentence after the clip?`
  ]) : isTwitch ? [
   ...
   - Are there exactly ${expectedScenes} === SCENE === markers?`,
    ...
    `10. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text, word for word: "Other Side of the Pillow. ClipzWorld News. I'm Bobby G. Let's get to it." FAIL this item (-15) if: the script uses "Hello everyone", uses an exclamation point in the intro, says "Welcome back", says "Twitch Soup", says "You are tuning into", greets the audience in any way, or deviates from the exact locked wording above.`,
   ...
   - Are there exactly ${expectedScenes} === SCENE === markers?`,
    ...
    `10. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text, word for word: "You are watching The Other Side of the Pillow. ClipzWorld News. Yesterday's games in the association. I'm Bobby G. Let's get to it." FAIL this item (-15) if: the script uses "Hello everyone", uses an exclamation point in the intro, says "Welcome back", greets the audience in any way, or deviates from the exact locked wording above.`,
   ...
   - Are there exactly ${expectedScenes} === HEADER === markers?`,
    ...
    `9. LOCKED INTRO (-15 if wrong): The === INTRO === scene MUST contain this EXACT text, word for word: "Because the Light Was On. ClipzWorld News. I'm Bobby G. Let's get to it." FAIL this item (-15) if: the script uses "Hello everyone", uses an exclamation point in the intro, says "Welcome back", says "Where we bring you", greets the audience in any way, or deviates from the exact locked wording above.`,
...
EXPECTED [CLIP PLAYS HERE] COUNT: ${expectedClips}`;
  ...
  const checklist = isTwitch ? [
    ...
    `9. LOCKED INTRO (-15 if wrong): The === TWITCH SHORT === or === INTRO === scene MUST open with: "Other Side of the Pillow. ClipzWorld News." FAIL this item (-15) if: "Hello everyone", exclamation point in intro, "Twitch Soup", "You are tuning into", or any audience greeting is present.`,
    ...
    `8. LOCKED INTRO (-15 if wrong): The script MUST open with: "The Daily Update. ClipzWorld News." (for shorts) or "You are watching The Other Side of the Pillow. ClipzWorld News. Yesterday's games in the association. I'm Bobby G. Let's get to it." (for compilations). FAIL (-15) if "Hello everyone", exclamation point, or any audience greeting is present.`,
    ...
    `8. LOCKED INTRO (-15 if wrong): The script MUST open with: "Because the Light Was On. ClipzWorld News." (for shorts) or "Because the Light Was On. ClipzWorld News. I'm Bobby G. Let's get to it." (for compilations). FAIL (-15) if "Hello everyone", exclamation point, "Where we bring you", or any audience greeting is present.`,
