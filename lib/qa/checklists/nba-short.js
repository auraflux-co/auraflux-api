'use strict';
/**
 * lib/qa/checklists/nba-short.js
 *
 * QA checklist module for NBA short-form videos.
...
// Short-form fix delegates to long-form nba module for clip references + scene guide
const clipReferences = nbaLong.clipReferences;
const sceneGuide = nbaLong.sceneGuide;
