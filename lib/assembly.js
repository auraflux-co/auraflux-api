          ...
          await new Promise((res, rej) => {
            ...
            const vfFilter = isAvatarSeg
              ...
              : `scale=1920:1080:force_original_aspect_ratio=increase,${sourceCropSize}scale=1920:1080,fps=fps=30` +
                ...
                // Expanded to x=1710 so the logo burn (x=1725, 90px wide) fully covers the left edge
                // without leaving a visible navy strip next to the logo.
                (contentType === 'news' && !isAvatarSeg ? ',drawbox=x=1710:y=900:w=210:h=180:color=0x0d1424@1.0:t=fill' : '');
