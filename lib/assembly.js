...
async function handleAssemble(req, res, saveJobCard) {
  const { segments, segmentData, labels, transition='crossfade', format='mp4', outputDir, jobTitle, assemblyId, contentType, jobId: assemblyJobId, jobSpecId: reqJobSpecId, sceneTextMap, fullScript, expectedClips: contractExpectedClips = 0 } = req.body;
