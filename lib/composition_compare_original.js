...
const DEFAULT_RATIOS = [0.08, 0.18, 0.32, 0.48, 0.62, 0.78, 0.9];
...
- captions_hooks: burned captions/hooks OR animated text overlays on SHORT frames (note: Whisper captions often burn only at EXECUTE — do NOT heavily penalize missing Whisper on near-final Review stills if anim text / hook cards are present; if ONLY watermark/logo, score low)
