...
// POST /job/:id/rollback
router.post('/job/:id/rollback', (req, res) => {
  const jobId = req.params.id;
...
// POST /job/:id/advance
router.post('/job/:id/advance', (req, res) => {
  const jobId = req.params.id;
  const card  = persistedJobs[jobId];
  if (!card) return res.json({ ok: false, error: 'Job not found: ' + jobId });
...
// POST /job/:id/manual-segments/resume
router.post('/job/:id/manual-segments/resume', (req, res) => {
  const jobId = req.params.id;
  const card  = persistedJobs[jobId];
...
// POST /job/:id/dismiss
router.post('/job/:id/dismiss', (req, res) => {
  const { id } = req.params;
...
// POST /job/:id/stuck
router.post('/job/:id/stuck', (req, res) => {
  const { id } = req.params;
...
// POST /job/:id/qa-confirm-generate
router.post('/job/:id/qa-confirm-generate', (req, res) => {
  const { id } = req.params;
  try {
