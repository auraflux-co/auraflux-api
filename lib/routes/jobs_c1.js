...
router.post(
  ...
  async (req, res) => {
    ...
    // CPD-485: captions config from wizard
    if (req.body.captions && typeof req.body.captions === 'object' && !jobSpec.captions) {
      jobSpec.captions = req.body.captions;
    }

    // CPD-485: audioOpts (normalization, ducking levels) from wizard
    if (req.body.audioOpts && typeof req.body.audioOpts === 'object' && !jobSpec.audioOpts) {
      jobSpec.audioOpts = req.body.audioOpts;
    }
