...
router.get(
  ...
  async (req, res) => {
    ...
    const isOperator = req.user.role === 'operator' || req.user.role === 'admin' || req.user.role === 'superadmin';
...
router.get(
  ...
  async (req, res) => {
    ...
    const { jobId } = req.params;
    const userId    = req.user.id;
    const isOp      = req.user.role === 'operator' || req.user.role === 'admin' || req.user.role === 'superadmin';
