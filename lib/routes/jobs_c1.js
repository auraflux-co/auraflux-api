 ...
 */
function _adaptLegacyPortal(mod) {
  return {
    runWorker:        (jobSpec) => mod.run(jobSpec),
    runIntervention:  mod.commit ? (jobSpec) => mod.commit(jobSpec) : null,
...
function _resolvePortalWorkers() {
  return {
    portal0:  _adaptLegacyPortal(require('../portals/portal0')),
    portal1:  _adaptLegacyPortal(require('../portals/portal1')),
    portal1b: _adaptLegacyPortal(require('../portals/portal1_video_reviewer')),
    portal2:  _adaptLegacyPortal(require('../portals/portal2')),
    portal3a: _adaptLegacyPortal(require('../portals/portal3a')),
    portal3b: _adaptLegacyPortal(require('../portals/portal3b')),
    portal4:  _adaptLegacyPortal(require('../portals/portal4')),
    portal5:  _adaptLegacyPortal(require('../portals/portal5')),
  };
}
