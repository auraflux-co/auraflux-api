...
You have full visibility into both what Framer currently publishes and what the Cloudflare Worker currently serves.

${designBrief ? `## Design Migration Brief\n${designBrief}\n\n` : ''}${framerContent ? `## Framer Published Content (live on auraflux.co via Framer)\n${framerContent}\n\n` : ''}${workerContent ? `## Worker-Owned Pages (live on auraflux.co, overriding Framer)\n${workerContent}\n\n` : ''}
