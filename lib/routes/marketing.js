...
function buildPrompt({ schemaLines, currentLines, designBrief, framerContent, pageFilesSection, workerContent, workerConstants, instruction }) {
  ...
  return [
    ...
    '{ "type": "html_patch", "page": "pricing"|"contact-content"|"roadmap-content", "description": "what changed", "html": "complete HTML" }',
    '',
    'Option D — multiple page body rewrites (page-specific content only — not for footer/nav):',
    '{ "type": "html_patches", "patches": [{ "page": "pricing", "description": str, "html": str }, ...] }',
    '',
    ...
    '- pricing.html: preserve ${FRAMER_FONTS || \'\'}, ${FRAMER_NAV || FALLBACK_NAV}, ${FRAMER_FOOTER || FALLBACK_FOOTER} as literal text.',
