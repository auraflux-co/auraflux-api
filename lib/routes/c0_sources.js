...
router.post(
  ...
  async (req, res) => {
    ...
    if (req.jobSpec) {
      ...
      try {
        const gates = {
          gate0: require('../gates/gate0'),
          gate1: require('../gates/gate1'),
          gate2: require('../gates/gate2'),
          gate3a: require('../gates/gate3a'),
          gate3b: require('../gates/gate3b'),
          gate4: require('../gates/gate4'),
          gate5: require('../gates/gate5'),
        };
