    ...
    setImmediate(async () => {
      try {
        ...
        if (!_hasSourceClips) {
          ...
          // portal1b, portal2, portal3a need assembled video (none for topic-only)
          // portal3b needs commitments/designSpec (not set for Operate API jobs)
          ['portal1b', 'portal2', 'portal3a', 'portal3b'].forEach((vpk) => {
