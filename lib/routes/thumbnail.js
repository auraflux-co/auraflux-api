 ...
 *
 * Routes:
 *   GET  /jobs/:jobId/thumbnail/candidates   customer+ — list generated candidates
 *   POST /jobs/:jobId/thumbnail/approve      customer+ — approve a candidate
 *   POST /jobs/:jobId/thumbnail/upload       customer+ — upload a custom thumbnail
 *   POST /jobs/:jobId/thumbnail/skip         operator+ — skip approval (proceed without)
 */
