 ...
 * POST /credits/webhook    — Stripe webhook handler (CPD-45)
 */
...
const { getCreditBalance, getClientPlan, getPool, insertCreditPack, hasStripeEvent, recordStripeEvent } = require('../db');
const { PACKS, createCheckoutSession, constructWebhookEvent } = require('../services/stripe_billing');
