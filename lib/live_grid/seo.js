...
const AUDIO_INSTRUCTIONS =
  '🔊 MEMBERS control the audio — subscribe, then !listen 1, 2, 3 or 4 to pick your screen instantly. ' +
  'Non-members hear auto-follow (highest viewers). !swap is members-only and unlocks at each like milestone. ' +
  'Like the stream to help us in the algorithm. Gold border = on-air screen.';
