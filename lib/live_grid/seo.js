...
/** ET calendar date for live titles — e.g. "Jun 16, 2026". */
...
const AUDIO_INSTRUCTIONS = [
  ...
  '❤️ Subscribe + like the stream to unlock !swap. Example: !swap 2 username (any Twitch). Gold border + AUDIO tag = on-air screen.',
];
...
function buildGridLiveDescription({ streamers = [], hookLine } = {}) {
  ...
  return [
    ...
    '• Gold border + AUDIO tag = the stream you hear right now',
    ...
    '👑 Gold border + AUDIO tag = on-air featured stream',
    '',
