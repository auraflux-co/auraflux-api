...
const AUDIO_INSTRUCTIONS =
  '🔊 CHAT controls the audio — type !listen 1, 2, 3 or 4 to vote for the screen you want to hear. ' +
  'Members get INSTANT audio (no vote wait). Members can !swap N streamer to put a live bench streamer on screen N. ' +
  'Majority wins for everyone else. The gold border shows who is on air. Like the stream — every 50 likes unlocks a thank-you!';
