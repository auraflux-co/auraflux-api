 ...
 * This is the Customer 1+ compatible version of generateNewscastOverlay().
 * Falls back to the default newscast template if designSpec is not available.
 *
 * @param {Object} jobSpec - Full job spec (may include designSpec.chrome.templateFile)
 * @param {Object} storyData - Story/segment data to render into the overlay
 * @param {string} outputPath - Absolute path to write the output PNG
 * @param {number} [storyIndex=0] - Which story/segment index is active
 * @param {Object} [options={}] - Additional options passed through to generateNewscastOverlay
 * @returns {Promise<string>} Path to generated overlay PNG
 */
