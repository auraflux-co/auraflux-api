 ...
 *   1. kick_fetch.py with KICK_PROXY_URL or Apify residential proxy (APIFY_API_TOKEN)
...
function buildApifyProxyUrl() {
  ...
  if (!token) return '';
  return `http://groups-RESIDENTIAL:${encodeURIComponent(token)}@proxy.apify.com:8000`;
}
