...
const ROLES = Object.freeze({
  CUSTOMER:   'customer',
  OPERATOR:   'operator',
  ADMIN:      'admin',       // per-account admin (team management)
  SUPERADMIN: 'superadmin',  // platform-wide access only
});

// Role hierarchy: higher index = more permissive upward
const ROLE_LEVEL = { customer: 1, operator: 2, admin: 3, superadmin: 4 };
