'use strict';
/**
 * AUTO_PUBLISH_PLATFORMS — controls which platforms Gate 5 / Upload-Post targets.
 *
 * - **Unset:** callers should use their own default (usually `['youtube']` from content type).
 * - **Set to empty, `none`, `skip`, or `0`:** no platforms → Gate 5 does not run (saves YouTube
 *   daily upload quota during full gate 0–4 E2E).
