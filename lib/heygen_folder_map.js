...
/**
 * Map pipeline contentType → HeyGen folder_id.
 * NOTE: the v3 API (POST /v3/videos, migrated 2026-06-09) does not accept folder_id —
 * this map is kept for logging/reference only; videos land in the default library.
...
function resolveHeyGenFolderId(contentType) {
  ...
  if (ct === 'nba' || ct === 'nba-short' || ct === 'sports-short' || ct === 'nfl' || ct === 'nfl-short') {
    return nbaNfl || null;
  }
