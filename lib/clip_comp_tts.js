...
function resolveVoiceId() {
  return process.env.ELEVENLABS_VOICE_ID
    ...
    || process.env.ECHOMIMIC_VOICE_ID;
}
 ...
 */
async function synthesizeSpeech(text, outputPath, { log = null } = {}) {
  ...
  try {
    const speakSpeed = parseFloat(process.env.ELEVENLABS_SPEAK_SPEED || process.env.ECHOMIMIC_SPEAK_SPEED || '1');
