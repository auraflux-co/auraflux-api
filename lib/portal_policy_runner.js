...
async function runUnifiedGatePolicy({
  ...
  // Short-circuit: hard_fail is a deterministic verdict — retrying the same worker
  // against the same file will not produce a different result. Skip all sendbacks
  // and interventions to avoid wasting N-1 extra portal runs.
