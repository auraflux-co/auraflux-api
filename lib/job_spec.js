 ...
 */
function deriveRequiredFeatures({ addOns = {}, extensions = {}, designSpec = {}, templateId = '', productionProfile = '' }) {
  const features = [];
  ...
  if (addOns?.branding?.active === true ||
    ...
    features.push({
      ...
      description: 'Brand logo or top-bar overlay must be visible in at least one frame',
    });
  }
