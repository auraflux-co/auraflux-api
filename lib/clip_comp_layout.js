...
function buildSplitScreenFilter(facecamRect, {
  ...
  // Live CSS cover-crops from the rect's top-left; match that when honoring boxes.
  ...
  if (bottomRect) {
    ...
    bottomChain = `[contentsrc]${contentPre}${botCrop},scale=1080:${bot}:force_original_aspect_ratio=increase,crop=1080:${bot}:${paneCropXY},setsar=1[bot]`;
  } else {
