...
const VIDEO_EFFECTS = {
  ...
  ken_burns(jobSpec) {
    ...
    // No s= param — inherit input dimensions to avoid changing aspect ratio.
    // scale=iw:ih before zoompan ensures dimensions are even numbers for libx264.
    return `scale=iw:ih,zoompan=z='zoom+${zoom}':x='iw/2-(iw/zoom/2)':y='ih/2-(ih/zoom/2)':d=${dur}`;
  },
