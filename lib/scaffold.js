...
const LOCKED_INTROS_FALLBACK = {
  ...
  'clips-long': `Welcome to Twitch Soup. I'm your host Bobby G, and for the next five minutes, I'll be your guide through the digital world that is livestreaming.`,
};
 ...
 * @param {string}   [customerId='c0']
 */
function buildUniversalLong(items, sceneShape, customerId = 'c0') {
  const shape =
