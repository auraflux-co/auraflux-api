 ...
 */
async function burnClipCompHookCaption(inputPath, outputPath, { text, designSpec, contentType, sharpBottom, log = null }) {
  ...
  const sharpBottomY = sharpBottom
    ...
    || 1264;
  const vf = _buildHookDrawtextFilters(lines, style, sharpBottomY);
