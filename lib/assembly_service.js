...
/**
 * Re-encode animated WebP file(s) from WAN generation into a single MP4.
 * Stream copy cannot be used because WebP is not compatible with the MP4 container.
 */
function _encodeWanToMp4(localPaths, outputPath) {
  return new Promise((resolve, reject) => {
    ...
    const encodeArgs = (inputPath) => [
      '-i', inputPath,
      '-vf', 'fps=16,scale=trunc(iw/2)*2:trunc(ih/2)*2',
