  ...
  for (let i = 0; i < urls.length; i++) {
    ...
    try {
      ...
      if (_isTwitchClipPageUrl(url)) {
        ...
        // CPD-350: Kick clips from Apify are HLS playlist URLs (.m3u8).
        // _downloadFile fetches the text manifest (not the video) → 0-duration file.
        // Use yt-dlp which handles HLS natively and muxes to mp4.
