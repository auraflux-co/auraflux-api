 ...
 */
async function _deductInTransaction(txClient, clientId, jobId, creditsUsed, balance, packs) {
...
async function consumeCredits(clientId, jobId, creditsUsed) {
  ...
  try {
    ...
    remaining = await _deductInTransaction(txClient, clientId, jobId, creditsUsed, freshBalance, freshPacks);
