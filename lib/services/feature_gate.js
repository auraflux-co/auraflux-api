...
const FEATURE_PLANS = {
  ...
  'zoom_punch': {
    min_plan:    'operate',
    label:       'Zoom punch',
    description: 'Digital zoom-in at AI-identified highlight moments via FFmpeg zoompan (CPD-415/1279)',
  },
  'video.camera_shake': {
    min_plan:    'operate',
    label:       'Camera shake / punch',
    description: 'Timed crop wobble for CapCut-style impact shakes (CPD-1280)',
  },
  'sound_effects': {
    min_plan:    'operate',
    label:       'Sound effects',
  ...
  'video.speed_ramp': {
    min_plan:    'operate',
    label:       'Speed ramp',
    description: 'Constant or timed speed segments (setpts + atempo) with audio sync (CPD-1281)',
  },
  'video.freeze_frame': {
    min_plan:    'operate',
  ...
  'ai.beat_sync': {
    ...
    description: 'PCM energy peak detect → Compose Beats→FX punch/shake suggestions (CPD-1282)',
  },
  'ai.transform_compare': {
    min_plan:    'operate',
    label:       'Gemini source vs Short transform QA',
    requires_env: ['GEMINI_API_KEY'],
    description: 'Frame-pair Gemini compare of original clip vs Composer Short (creative QA only)',
  },
  'visual.waveform': {
    min_plan:    'operate',
