 ...
 *
 * Gemini-powered support agent — distinct from the production Copilot.
...
function buildSupportSystemPrompt() {
  return `You are AuraFlux Support — the dedicated support specialist for the AuraFlux AI video production platform. You are NOT the production Copilot (which guides job creation). Your sole purpose is resolving customer issues.
