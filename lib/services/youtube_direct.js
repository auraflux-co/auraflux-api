...
async function applyLiveBroadcastSeo(broadcastId, seo = {}, { thumbnailPath, log = () => {}, playlistId, membersOnlyChat } = {}) {
  if (!broadcastId || !seo?.title) return { ok: false };
  const out = { ok: true, tags: false, playlist: false, thumbnail: false, channelKeywords: false, chatPolicy: false };
