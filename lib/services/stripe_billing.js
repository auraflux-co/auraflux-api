...
const PLANS = {
  diy: { id: 'operate', label: 'AuraFlux Operate', credits: 400, price_usd: 999, brands: 1, collab_mode: 'guides' },
  dwy: { id: 'guided', label: 'AuraFlux Guided',  credits: 1200, price_usd: 2499, brands: 3, collab_mode: 'full' },
  dfy: { id: 'managed', label: 'AuraFlux Managed', credits: 2000, price_usd: 4499, brands: 5, collab_mode: 'full', has_account_manager: true },
};
