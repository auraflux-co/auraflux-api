 ...
 */
async function createCheckoutSession(clientId, packId, successUrl, cancelUrl, quantity = 1) {
 ...
 */
async function createSubscriptionCheckoutSession(clientId, planId, successUrl, cancelUrl, brandId = null) {
