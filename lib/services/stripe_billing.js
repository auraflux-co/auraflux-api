...
const PLANS = {
  diy: {
    ...
    credits:     400,
    price_usd:   999,
    description: 'Run your content system — 1 brand, self-serve, guides + Collab (guide mode)',
    brands:      1,
    collab:     'guides',
    no_rollover: true,
  },
  dwy: {
    ...
    credits:     1200,
    price_usd:   2499,
    description: 'Build and optimize with us — 3 brands, full Collab + SMS support',
    brands:      3,
    collab:     'full',
    no_rollover: true,
  },
  dfy: {
    ...
    credits:     2000,
    price_usd:   4499,
    description: 'Full content operation, handled for you — 5 brands, Collab + account manager',
    brands:      5,
    collab:     'full',
    am:          true,
    no_rollover: true,
