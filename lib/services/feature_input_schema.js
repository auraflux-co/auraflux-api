...
const FEATURE_INPUTS = [
  ...
  // ── Visual effects ─────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        default:  'crossfade',
        options: [
          { id: 'crossfade',  label: 'Crossfade — smooth fade overlap (default)' },
          { id: 'fade_black', label: 'Fade to black' },
          { id: 'wipe_left',  label: 'Wipe left' },
          { id: 'dissolve',   label: 'Dissolve' },
        ],
        hint: 'Only applied when transitions is true. Defaults to crossfade.',
      },
      {
        id:       'slowmo',
        label:    'Slow motion',
  ...
  // CPD-505: customer-provided publish metadata — used by portal5 before fallback to publishCopy
  {
    ...
    description: 'Title, description, tags, and privacy for the published video. Overrides the AI-generated publishCopy.',
    apiField:    'publishMeta',
    payloadPath: 'publishMeta',
    inputs: [
      {
        id:       'title',
        label:    'Video title',
        ...
        required: false,
        default:  null,
        hint:     'Displayed on YouTube / TikTok. Max 100 characters for YouTube.',
      },
      {
        id:       'description',
        label:    'Description',
        ...
        required: false,
        default:  null,
        hint:     'Video description. Chapter timestamps are appended automatically if assembly produces segment durations.',
      },
      {
        id:       'tags',
        label:    'Tags',
        ...
        required: false,
        default:  null,
        hint:     'Comma-separated list of tags for YouTube. Ignored by TikTok.',
      },
      {
        id:       'privacyStatus',
        label:    'Privacy',
        ...
        default:  'private',
        options: [
          { id: 'public',    label: 'Public — visible to everyone immediately' },
          { id: 'unlisted',  label: 'Unlisted — viewable via link only' },
          { id: 'private',   label: 'Private — only you can see it' },
        ],
        hint: 'Defaults to private for safety. Set to public or unlisted to publish openly.',
      },
      {
        id:       'tiktokCaption',
        ...
        required: false,
        default:  null,
        hint:     'Optional TikTok-specific caption (max 2200 characters). Falls back to description if not set.',
      },
      {
        ...
        required: false,
        default:  null,
        hint:     'ISO 8601 datetime to schedule publishing. Leave null to publish immediately after Portal 5 runs.',
      },
    ],
    examplePayload: { publishMeta: { title: 'My Top Clips', description: 'Best moments from the stream', tags: 'gaming,clips,twitch', privacyStatus: 'public' } },
  },

  // ── Thumbnail ───────────────────────────────────────────────────────────────────────
  // CPD-506/CPD-512: thumbnail generation config and approval
  {
    id:          'thumbnail',
    label:       'Thumbnail',
    description: 'Auto-generate and select a thumbnail for the published video.',
    apiField:    'spec.addOns.thumbnail_ext',
    payloadPath: 'addOns.thumbnail_ext',
    inputs: [
      {
        id:       'ordered',
        ...
        required: false,
        default:  true,
        hint:     'Automatically generates thumbnail candidates after assembly. Enabled by default on all plans.',
      },
      {
        id:       'style',
        ...
        default:  'frame',
        options: [
          { id: 'frame',    label: 'Frame — best-scored video frame' },
          { id: 'designed', label: 'Designed — AI-composed with text overlay' },
          { id: 'vectcut',  label: 'VectCut — AI-cropped professional frame' },
          { id: 'imagen',   label: 'Imagen 3 — fully generative (managed tier only)' },
        ],
        hint: 'Defaults to frame for all plans. Imagen 3 requires managed tier.',
      },
      {
        id:       'approvalRequired',
        ...
        required: false,
        default:  false,
        hint:     'When true, the job enters staged status and waits for customer to select a thumbnail before publishing.',
      },
    ],
    examplePayload: { thumbnail_ext: { ordered: true, style: 'frame' } },
  },
];
