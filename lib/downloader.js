...
const TRUSTED_DOMAINS = [
  ...
  'static-cdn.jtvnw.net',         // Twitch Helix clip CDN (thumbnailToMp4, 2026+)
  'jtvnw.net',                    // Twitch static assets
  'twitch-video-assets',          // Twitch VOD/clip asset paths on jtvnw CDN
  'twitch.tv',                    // CPD-1014: clip/VOD page URLs
  'clips.twitch.tv',
  'kick.com',
