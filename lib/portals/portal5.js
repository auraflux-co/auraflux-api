...
async function run(jobSpec, gate4Report) {
  ...
  // For contentType='clips' jobs portal4 is intentionally skipped (no broadcast QA
  // needed for clip compilations). In that case the assembled R2 video URL is the
  // equivalent signal — if the video made it to R2, publishing is safe to proceed.
  const clipsVideoReady = !gate4Report &&
