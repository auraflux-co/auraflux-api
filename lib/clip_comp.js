...
function applyClipCompProfileToJobSpec(jobSpec, opts = {}) {
  ...
  jobSpec.productionPath = jobSpec.productionPath || 'short_compile_clips';
  jobSpec.format = jobSpec.format || 'short';
  jobSpec.productionProfile = jobSpec.productionProfile || 'vertical_reel';
