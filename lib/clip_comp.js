 ...
 */
function resolveClipCompPublishContentType(jobContentType, compCreative = null) {
  if (compCreative?.preset === 'reaction_short') return 'reaction-short';
  const allowed = ['twitch-short', 'news-short', 'sports-short', 'reaction-short', 'twitch-vod-comp', 'news-vod-comp', 'sports-vod-comp'];
