...
function resolveClipCompPublishContentType(jobContentType) {
  const allowed = ['twitch-short', 'news-short', 'sports-short', 'twitch-vod-comp', 'news-vod-comp', 'sports-vod-comp'];
...
function buildClipCompDesignSpec({
  ...
  const { mergeCompCreative, compCreativeAssemblyFlags } = require('./clip_comp_creative');
