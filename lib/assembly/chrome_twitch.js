...
async function burnChrome(ctx) {
  ...
  try {
    ...
    if (isStreamerIntro) {
      ...
      await generateChromeOverlay(overlayBase, overlayVisiblePath, activeIdx, {
        showLowerThird: true,
        hideSidebar: false,
        episodeNumber,
      ...
      await generateChromeOverlay(overlayBase, overlayHiddenPath, activeIdx, {
        showLowerThird: true,
        hideSidebar: false,
        episodeNumber,
        activeCategory: 'ON STREAM',
      ...
      await generateChromeOverlay(overlayBase, overlayBodyPath, activeIdx, {
