  ...
  try {
    ...
    if (isStoryIntro) {
      ...
      await generateNewscastOverlay(overlayBase, overlayVisiblePath, activeStoryIndex, {
        showLowerThird: true, hideSidebar: true, episodeNumber, activeCategory, contentType: 'news'
      });
      ...
      await generateNewscastOverlay(overlayBase, overlayBodyPath, activeStoryIndex, {
        showLowerThird: true, hideSidebar: false, episodeNumber, activeCategory, contentType: 'news'
      });
      ...
      await generateNewscastOverlay(overlayBase, overlayHiddenPath, activeStoryIndex, {
        showLowerThird: false, hideSidebar: false, episodeNumber, activeCategory, contentType: 'news'
      });
