...

{
  ...
  "youtube": {
    ...
    "description": "${isShort ? '1-2 punchy sentences (under 120 chars total). Hook first, then ' + cc.handle + '. Hashtags go in the hashtags field — NOT inline here.' : `FULL structured description (use \\\\n for line breaks) following this EXACT section order (PUBLISH_COPY_SPEC.md): (1) 'Welcome to ${cc.showName} by ClipzWorld News [show emoji] — [one-line tagline]'. (2) Episode hook: 1-2 sentences naming the single biggest specific moment + 'plus [N] more...'. (3) Per-segment breakdown: one short punchy paragraph per streamer/story/game describing their moment, each opening with the #name hashtag. (4) If a CHAPTERS block was provided above, include it VERBATIM under '⏱️ TIMESTAMPS'. (5) If 'Streamers featured' was provided above, include '🎮 Featured Streamers (Support Them 💜)' listing every name + twitch.tv URL EXACTLY as given (NBA: '🏀 Games Featured'; News: '📰 Stories Covered'). (6) '😂 What You'll See:' 4 bullets specific to THIS episode. (7) Subscribe CTA + upload cadence + 🔔. (8) '🎤 Hosted by: ${cc.host}'. (9) '📢 Disclaimer: All content belongs to respective streamers. Used for entertainment and highlight purposes.' (10) Final line: 3-5 hashtags. 250-450 words.`}",
