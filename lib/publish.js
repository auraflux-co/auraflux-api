...
function ensurePublishMetadataComplete(metadata, { streamers = [], cc = {}, isShort = false, clipCount = 0, compCreative = null, contentType = '' } = {}) {
  if (!metadata || typeof metadata !== 'object') return metadata;
...
${geminiBriefGuidance}${rankedListSeoGuidance}${nbaSeoGuidance}${clipCompSportsGuidance}${newsSeoGuidance}${twitchClipShortDescriptionGuidance}${twitchClipTitleGuidance}${twitchLongFormGuidance}
