...
function inferFailureClass(evt = {}) {
  ...
  const qa =
    /\b(clip analysis|authorized facts|cannot be verified against clip|gate 0|no score data|missing.*analysis|gemini.*clip|video metadata|no video analysis|qa input)\b/i;
