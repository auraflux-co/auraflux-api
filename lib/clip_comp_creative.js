...
const COMP_CREATIVE_CATALOG = {
  ...
  fableflow_speed: {
    ...
    layout: 'Full-bleed edge-to-edge · no brand-pad · no split',
    audio: 'ES music bed + light whoosh · Punch look · Beats→FX suggested',
    outcome: 'Faceless Speed Short: peak → trim → Beats→FX → EXECUTE → Fable-style title at publish',
  },
  custom: {
    code: 'C7',
