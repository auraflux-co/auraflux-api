...
const PRESET_DEFAULTS = {
  ...
  reaction_short: {
    ...
    look: { preset: 'vivid' },
    transition: { style: 'cut', durationSec: 0.35 },
    beatSync: { suggestOnPreview: true, source: 'music_bed', maxPeaks: 6 },
...
const PRESET_LABELS = {
  ...
  reaction_short: 'Reaction Short (hooks + beat flashes)',
...
const COMP_CREATIVE_CATALOG = {
  ...
  reaction_short: {
    code: 'C10',
    name: 'Reaction Short',
    tagline: 'Reaction packaging — vivid punch, timed hooks, music-bed beats (Transform 5/5 recipe)',
    buttons: ['Short'],
    shortClips: '1 clip / VOD peak → 1 Short',
    compClips: 'Not for this preset — use Short only',
    compVodClips: null,
    whisper: true,
    hooks: 'Hooks + Whisper · 4 timed anim lines (WATCH THIS → THE DROP)',
    layout: 'Full-bleed solo 9:16 (reaction / stage / performance)',
    audio: 'low_trap bed + whoosh · vivid look · Beats→FX on music bed · punch_pause',
