...
app.post('/generate-clip-comp', async (req, res) => {
  ...
  const card = {
    ...
    editorSignedOffAt,
    primaryKeyword: compositionSpecIn?.primaryKeyword || req.body.primaryKeyword || null,
    deliveryAspect: compositionSpecIn?.deliveryAspect || req.body.deliveryAspect || '9:16',
    momentFinderPrefs: compositionSpecIn?.momentFinderPrefs || req.body.momentFinderPrefs || null,
    momentCandidatesVersion: compositionSpecIn?.momentCandidatesVersion || 0,
