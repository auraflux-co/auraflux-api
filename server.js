...
// ── Direct YouTube OAuth (CPD-923) — also on broadcast sidecar ─────────────
...
const compositionRouter    = require('./lib/routes/composition');
const creatorExtensionsRouter = require('./lib/routes/creator_extensions');
const creatorStatsRouter   = require('./lib/routes/creator_stats');
const creatorScheduleRouter = require('./lib/routes/creator_schedule');
const creatorLibraryRouter = require('./lib/routes/creator_library');
...
app.use(creatorExtensionsRouter);
app.use(creatorStatsRouter);
app.use(creatorScheduleRouter);
app.use(creatorLibraryRouter);
