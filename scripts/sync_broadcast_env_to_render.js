...
const env = {
  ...
  LIVE_GRID_X264_PRESET: 'superfast',
  ...
  LIVE_GRID_BITRATE_K: process.env.LIVE_GRID_BITRATE_K_RENDER || '4500',
  LIVE_GRID_AUDIO_BITRATE_K: process.env.LIVE_GRID_AUDIO_BITRATE_K || '192',
  LIVE_GRID_AUDIO_DIRECT: process.env.LIVE_GRID_AUDIO_DIRECT || 'on',
  LIVE_GRID_AUDIO_COPY: process.env.LIVE_GRID_AUDIO_COPY || 'off',
