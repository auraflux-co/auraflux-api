...
const desired = {
  ...
  /** Kick OAuth live probe + token refresh on sidecar (same DB as auraflux-api). */
  LIVE_GRID_KICK_OAUTH_CUSTOMER_ID: process.env.LIVE_GRID_KICK_OAUTH_CUSTOMER_ID,
  ...
  LIVE_GRID_KICK_HLS_STALL_MS: process.env.LIVE_GRID_KICK_HLS_STALL_MS || '90000',
