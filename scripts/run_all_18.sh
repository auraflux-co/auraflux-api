...
# API base — used by Operate (Python) tests against the backend
...
# App base — used by Guided/Managed (browser) tests against the frontend
...
export GEMINI_API_KEY AURAFLUX_E2E_API_KEY_OPERATE AURAFLUX_E2E_BASE AURAFLUX_APP_BASE CLERK_SECRET_KEY
