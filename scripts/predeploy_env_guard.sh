...
LOCAL_SKIP_KEYS="VECTCUT_API_URL,DASHBOARD_PORT,ANTHROPIC_API_KEY,ATLASSIAN_API_TOKEN,ATLASSIAN_DOMAIN,ATLASSIAN_EMAIL,JIRA_PROJECT_KEY,JIRA_WEBHOOK_SECRET,CONFLUENCE_SPACE_KEY,NEW_RELIC_APP_NAME,NEW_RELIC_LICENSE_KEY,NEW_RELIC_USER_KEY,RENDER_API_KEY,GATE_TEST_MODE"
