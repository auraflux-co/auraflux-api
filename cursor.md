...
**C0 vs Render (CPD-1021):** Read the **Worker Memory** block at the top of `STATUS.md` first. **Confluence HOW:** [Server Split — C0/C1+ Boundary](https://aurafluxco.atlassian.net/wiki/spaces/CP/pages/6881341). Local mirror: `docs/C0_REPOSITORY_POLICY.md` · Rule: `.cursor/rules/c0-render-separation.mdc`
