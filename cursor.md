...
```json
{
  ...
  "preflight": {
    ...
    "packages": [{
      ...
      "youtube": { "title": "...", "description": "...", "tags": [], "pinnedComment": "...", "privacyStatus": "private", "scheduledAt": null },
...
**SCAFFOLD** *(optional)* — called when `fetch.status = complete` AND `order.designSpec.scaffold = true`
