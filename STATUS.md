...
**Branch:** main | **Latest Commit:** Fix 5 — fix(news): /newscast-overlay route path — tools/ prefix missing (server.js:1300). Full 5-fix series: orderedClipUrls (e17e647), cardData+newsItems (eb67b0e), Gate 3 clip detection (9271297), concat demuxer (ca56ccb), newscast-overlay path (pending).
