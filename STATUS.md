...
| Claude Code | Fix Jay Cinco intro card missing: underscore→space normalization in streamer lookup (server.js:3714). Scene headers use underscores, displayNames use spaces — lookup failed silently for multi-word names. | `server.js`, `STATUS.md` | pending | 2026-04-12 1:00 AM ET |
