...
**Last Updated:** 2026-04-10 (5:28 PM ET)
**Branch:** main | **Latest Commit:** `84a780c` — fix: explicit scene→clip mapping in Gemini prompt (Fix #5 — prevents clip 1/2 swap in 52-scene script)
