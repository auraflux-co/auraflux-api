...
const FRAMER_ORIGIN = 'https://bd649f83.auraflux-marketing.pages.dev';
...
function addSecurityHeaders(headers) {
  ...
  // M3: CSP — allow self + known third-party scripts (Framer assets, Cloudflare Analytics)
  headers.set('Content-Security-Policy', [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' assets.framer.com static.cloudflareinsights.com",
